...
const JobsItem: FC = () => {
  ...
  return (
    <>
      {data.map(({ id, createdAt, title, pictures, location, name }) => {
        return (
          <li
            key={id}
            ...
            <Link className="flex" to={`/jobs-list/${id}`}>
              ...
              <div className="w-[100%] xlMin:w-[750px] ml-[19px] xlMin:ml-[26px]">
                ...
                <div className="flex items-center">
                  ...
                  <p className="ml-2 font-normal text-base text-secondaryTextColor">{`Lat: ${location.lat} Long: ${location.long}`}</p>
                </div>
              </div>
            </Link>
          </li>
